...
enum {
	...
	TXT_FILL_6, /* Sidepanels */

	TXT_SIDEPANEL_CHANNEL_ACTIVE,
	TXT_SIDEPANEL_CHANNEL_ACTIVITY,
	TXT_SIDEPANEL_CHANNEL_NORMAL,
	TXT_SIDEPANEL_NICK_OP,
	TXT_SIDEPANEL_NICK_VOICE,
	TXT_SIDEPANEL_NICK_NORMAL,
	TXT_SIDEPANEL_NICK_AWAY,
