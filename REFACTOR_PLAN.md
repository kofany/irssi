...
**CEL GŁÓWNY**: Zachować pełną funkcjonalność natywnych paneli irssi utworzonych wcześniej (celem zastąpienie adv_windowlist + tmux_nicklist_portable + chansort_configurable + mouse.pl) przy jednoczesnej poprawie jakości kodu, wydajności i maintainability.
...
**Current Branch**: `fix/sidepanels-qoder`
